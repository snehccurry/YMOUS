...
cd ~
{
git clone https://github.com/snehccurry/YMOUS
} &> /dev/null
fi
...
{
cd bin
cp ymous /usr/local/bin
chmod +x /usr/local/bin/ymous
cp  /bin
chmod +x /bin/ymous
cp ymous /data/data/com.termux/files/usr/bin
chmod +x /data/data/com.termux/files/usr/bin/ymous
} &> /dev/null
